...
buf.push('<!DOCTYPE html>\n<html lang="en" ng-app="app">\n  <head>\n    <meta charset="utf-8">\n    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">\n    <meta name="viewport" content="width=device-width" initial-scale="2.0">\n    <meta name="description" content="">\n    <meta name="author" content="">\n    <title ng-bind-template="Jinkubator"></title>\n    <link rel="stylesheet" href="css/app.css"><!--[if lte IE 7]>\n    <script src="http://cdnjs.cloudflare.com/ajax/libs/json2/20110223/json2.js"></script><![endif]--><!--[if lte IE 8]>\n    <script src="//html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->\n    <script>\n      window.brunch = window.brunch || {};\n      window.brunch[\'auto-reload\'] = {\n          enabled: true\n      };\n    </script>\n    <script src="js/vendor.js"></script>\n    <script src="js/app.js"></script>\n  </head>\n  <body ng-controller="AppCtrl">\n    <div class="top-menu">\n      <div class="top-menu-inner"><a href="#/home" class="brand">wjug</a>\n        <div ng-include="\'partials/nav.html\'" class="nav"></div>\n      </div>\n    </div>\n    <div class="wrapper">\n      <div class="main-content">\n        <div ng-switch="subview" class="subview">\n          <div ng-switch-when="loading" ui-animate>\n            <div page="1" class="section">\n              <div class="centered">\n                <div class="container">\n                  <div class="row">\n                    <div class="span12">\n                      <p>loading...</p>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n          <div ng-switch-when="main_page" ng-include=" \'partials/main_page.html\' " ui-animate></div>\n          <div ng-switch-when="prelegents" ng-include=" \'partials/prelegents.html\' " ui-animate></div>');
 for (var meeting_id = 1; meeting_id <= 22; meeting_id++)
{
buf.push('\n          <div');
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>17 Spotkanie</h4>\n            <h2>Spock</h2>\n            <h3>Dominik Przybysz</h3>\n            <p>Termin: 24.06.2014</p>\n            <p>Lokalizacja: MiM UW, s. 3180</p>\n            <h3>O prezentacji:</h3>\n            <p> </p>Czy można pisać testy bez takich bibliotek jak JUnit, TestNG i festAssert? Mockować bez Mockito? Łapać wyjątki bez catch-exception? Oczywiście, że można. Odpowiedzią jest Spock.\n            <p></p>Podczas prezentacji przyjrzymy się możliwościom Spocka w testowaniu kodu javowego i grooviowego. Zobaczymy jak pisać w stylu given-when-then, sprawdząć warunki nie używając słowa "assert", jak zasilać testy danymi, udawać, że mamy zależności testowanego obiektu i pisać testy integracyjne z podniesionym kontekstem springa.\n            <h3>O prelegencie:</h3>\n            <p>Większość życia spędził pisząc w javie, ale zdarzało mu się oskryptowywać różne rzeczy w pythonie lub shellu. Ostatnio szczęśliwy użytkownik grooviego. Uwielbia testowanie oraz wszelką automatyzację w procesie wytwarzania oprogramowania. Stara się dbać o czystość kodu (własnego i cudzego) pooprzez częste code review.</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>18 Spotkanie</h4>\n            <p>Termin: 21.10.2014</p>\n            <p>Lokalizacja: MiNI</p>\n            <p>Sponsor: <a href="http://www.4financeit.com/" target="_blank"><img src="img/sponsors/4finance.png" width="200"/></a></p>\n            <h2>Maven</h2>\n            <h3>Paweł Cesar Sanjuan Szklarz</h3>\n            <h3>O prezentacji:</h3>\n            <p></p>Stolarz musi umieć młotka używać, programista javy musi używać maven. Wytłumaczę jak używać mavena, przejdziemy po pełnej dokumentacji a co ważniejsze, opowiem do czego nie używać.\n            <p>Dokumentację do Mavena można znaleźć <a href="http://books.sonatype.com/mvnref-book/reference/">tutaj</a></p>\n            <p>Link do prezentacji: <a href="https://docs.google.com/presentation/d/1nZBK5jLg1uGRaPsc7YGZgEfCBMRNvr82R75JTWWu50I/edit?usp=sharing">Maven</a></p>\n            <h3>O prelegencie:</h3>\n            <p>Polak-Meksykanin, Matematyk z wykształcenia. Interesuję się programowaniem funkcyjnym i metodami formalnymi. Używam od 5 lat Guice produkcyjnie.</p>\n            <h2>Gradle</h2>\n            <h3>Dawid Kublik</h3>\n            <h3>O prezentacji:</h3>\n            <p></p>Na najbliższym wykładzie spróbuje podzielić się swoim rocznym doświadczeniem z technologią poruszając podstawowe zagadnienia takie jak różnice w stosunku do mavena, taski, projekty (single i multi), pluginy, gradle DSL, itd.\n            W przeciwieństwie od ostatniej prezentacji na WGUG\'u - wykład ma celu przedstawienie podstaw i nie wymaga jakiegokolwiek doświadczenia z gradle.\n            Gwarantujemy niezapomniane emocje.\n            <p>Linki do prezentacji: <a href="https://docs.google.com/presentation/d/1GCeo4_zjPBeWWNEobjgRmGzKdtC23mGQp6wg3HzrkVw">slajdy, </a><a href="https://github.com/dkublik/jinkubator-basic-gradle-maven-comparison">porównanie mavena i gradle\'a</a> oraz <a href="https://github.com/dkublik/jinkubator-gradle-presentation-tutorial">kod do prezentacji.</a></p>\n            <h3>O prelegencie:</h3>\n            <p>Na co dzień pracuje w 4finance i prawdopodobnie do końca życia budowałby w mavenie gdyby firma nie zmusiła go do przejścia na gradle. Dziś nie żałuje niczego.</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>19 Spotkanie</h4>\n            <h2>TDD</h2>\n            <h3>Adam Pierzchała</h3>\n            <p>Termin: 4.11.2014</p>\n            <p>Lokalizacja: MiNI PW</p>\n            <p>Sponsor: <a href="http://www.pragmatists.pl/" target="_blank"><img src="img/sponsors/pragmatists.png" width="200"/></a></p>\n            <h3>O prezentacji:</h3>\n            <p> </p>Na spotkaniu opowiem o tym w czym i w jaki sposób TDD oraz samo testowanie pomaga w codziennym kodowaniu. Pokażę w jaki sposób pisać testy, jakich błędów unikać oraz jak czerpać z tego frajdę. Powiem też w jaki sposób pisząc mniej można tworzyć więcej i oszczędzać przy tym czas. Będą przykłady, będzie kodowanie i przykłady z życia wzięte.\n            <h3>O prelegencie:</h3>\n            <p>Jestem programistą w firmie Pragmatists, gdzie na co dzień stosuję Test Driven Design, Pair Programming i wiele innych technik zapożyczonych z XP. Interesuję się Domain Driven Design, technikami tworzenia czystego kodu, XP, oraz usprawnianiem pracy zespołów agilowych. Jestem też jednym z organizatorów Jinkubatora.</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>20. Spotkanie</h4>\n            <h2>Groovy</h2>\n            <h3>Marcin Grzejszczak</h3>\n            <p>Termin: 2.12.2014</p>\n            <p>Lokalizacja: MiNI PW</p>\n            <p>Sponsorzy: <a href="http://www.4financeit.com/" target="_blank"><img src="img/sponsors/4finance.png" width="220"/></a>  <a href="http://touk.pl/nieustanna-rekrutacja" target="_blank"><img src="img/sponsors/touk.jpg" width="100"/></a></p>\n            <h3>O prezentacji:</h3>\n            <p>Podczas tej prezentacji przedstawię podstawy wspaniałego języka Groovy. Opowiem o jego strukturze, składni i udowodnię, że znając Javę, nauczysz się Grooviego w klika chwil. Wskażę jak najlepiej moim zdaniem wykorzystać moc Groovyego w taki sposób, żeby nie doprowadzić swoich współpracowników do furii, a siebie nie skazać na wieczne potępienie. </p>\n            <p>Jeśli nie wiesz nic o Groovym - doskonale, to spotkanie jest właśnie dla Ciebie. Robiłeś coś w Groovym? Jestem przekonany, że dowiesz się paru nowych rzeczy.</p>\n            <p>Mam nadzieję, ze po tej prezentacji dojdziesz do wniosku, że Groovy jest odpowiedzią na wiekszość Twoich problemów z Javą i stanie się językiem, z którego będziesz korzystać każdego dnia. </p>\n            <h3>O prelegencie:</h3>\n            <p>Senior Software Developer w 4finance zafascynowany architekturą mikroserwisow i czystym kodem. Kontrybutor do open sourceowych projektow (miedzy innymi Drools, Moco, Mockito, Uptodate Gradle Plugin). Wspolautor rozwiazania @Builder oraz ExternalStrategyBuilder w Groovy. Wspolautor biblioteki Micro-Infra-Spring. Wspolzalozyciel Warszawskiej Grupy Uzytkonikow Grooviego (WGUG).</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>21. Spotkanie</h4>\n            <h2>Git</h2>\n            <h3>Adam Ruka</h3>\n            <p>Termin: 16.12.2014</p>\n            <p>Lokalizacja: MiNI PW</p>\n            <p>Sponsor: <a href="http://www.pragmatists.pl/" target="_blank"><img src="img/sponsors/pragmatists.png" width="200"/></a></p>\n            <h3>O prezentacji:</h3>\n            <p>Git zrewolucjonizował świat kontroli wersji i jest obecnie zdecydowanie najpopularniejszym narzędziem tego typu. Dlatego dobra jego znajomość w dzisiejszych czasach jest praktycznie obowiązkowa - zarówno w pracy, jak i np. przy kontrybuowaniu do projektów open-source. </p>\n            <p>Niestety, Git nie należy do najprostszych narzędzi do nauczenia się dla początkujących, a słaby interfejs command-line nie poprawia sytuacji. Na tym warsztacie mam nadzieję oswoić bestię i pokazać, że nie jest taka straszna, jak ją malują, a daje możliwości nieporównywalne z narzędziami istniejącymi wcześniej. </p>\n            <p>Zaczniemy od zilustrowania różnicy pomiędzy tradycyjnymi Version Control Systems a Distributed VCS\'ami, takimi jak Git. Postaram się wyjaśnić koncepcje Gitowe poprzez analogie do ich SVNowych odpowiedników, a następnie zademonstruję podstawowy workflow, który powinien wystarczyć w 80% przypadków. Omówimy także narzędzia graficzne oraz integrację z różnymi IDE. </p>\n            <p>Następnie pokażę GitHub - najpopularniejszy serwis do hostowania repozytoriów Gitowych, który zrewolucjonizował wspólną pracę nad kodem. Pozostały czas poświęcimy na ostatnie 20% wspomnianego workflow - opowiem o branchach, merge\'ach i modelach branchingu, aliasach, remote\'ach, co to jest rebase i do czego służy, a także pokażę, jak Git może być używany w innych domenach - np. do deployowania aplikacji w chmurze. </p>\n            <h3>O prelegencie:</h3>\n            <p>Doświadczony Java/JavaScript full-stack developer pracujący na co dzień w Pragmatists. Interesuje się TDD, DDD i automatyzacją wszystkiego, co trzeba zrobić przynajmniej dwa razy. Gita pokochał od pierwszego wejrzenia, wdraża go wszędzie gdzie się da (plus próbował w kilku miejscach, gdzie się nie da) i obecnie odmawia pracy z jakimkolwiek innym narzędziem do kontroli wersji :).</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<div>\n  <div page="1" class="section">\n    <div class="centered">\n      <div class="container">\n        <div class="row">\n          <div class="span12">\n            <h4>22. Spotkanie</h4>\n            <h2>Guava - niezbędnik programisty</h2>\n            <h3>Piotr Betkier</h3>\n            <p>Termin: 13.01.2015</p>\n            <p>Lokalizacja: MiNI PW</p>\n            <h3>O prezentacji:</h3>\n            <p>Java, pomimo znaczących zmian na plus w wersji 8, wciąż pozostaje językiem dość prymitywnym, z kiepskim API w wielu obszarach JDK. Z odsieczą przychodzi Guava, biblioteka od Googla, która uzupełnia wiele z tych braków pomagając pisać zwięzły i przejrzysty kod. Od lat jest to niezbędnik w arsenale każdego programisty Javowego.</p>\n            <p>W ramach warsztatów pokażę jakie możliwości daje Guava i jakie problemy rozwiązuje. Będziemy między innymi refaktoryzować przerośnięty kod napisany z samym JDK do czystszej postaci z wykorzystaniem Guavy. Będzie też trochę o JDK 8, które wypełniło kilka luk tradycyjnie wypełnianych Guavą.</p>\n            <h3>O prelegencie:</h3>\n            <p>Na co dzień rozwija backendowe usługi i aplikacje webowe w Allegro, wcześniej szukał bozonu Higgsa w CERN. Przez większość czasu żyje w świecie Javy i JVM, ale chętnie wraca do Pythona. W ramach odskoczni od IT uwielbia aktywny wypoczynek pod każdą postacią.</p>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<ul>\n  <li><a href="#/meeting/18">18. Gradle</a></li>\n</ul>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<ul> \n  <li><a href="#/meeting/20">20. Groovy</a></li>\n</ul>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
var interp;
var __indent = [];
buf.push('\n<ul> \n  <li><a href="#/meeting/5">5. 	Guava - JDK na sterydach</a></li>\n  <li><a href="#/meeting/22">22.  Guava - niezbędnik programisty</a></li>\n</ul>');
}
return buf.join("");
};module.exports = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
...
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Doświadczony Java/JavaScript full-stack developer pracujący na co dzień w Pragmatists. Interesuje się TDD, DDD i automatyzacją wszystkiego, co trzeba zrobić przynajmniej dwa razy. Gita pokochał od pierwszego wejrzenia, wdraża go wszędzie gdzie się da (plus próbował w kilku miejscach, gdzie się nie da) i obecnie odmawia pracy z jakimkolwiek innym narzędziem do kontroli wersji :).</p>\n');
buf.push.apply(buf, __indent);
...
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Senior Software Developer w 4finance zafascynowany architekturą mikroserwisow i czystym kodem. Kontrybutor do open sourceowych projektow (miedzy innymi Drools, Moco, Mockito, Uptodate Gradle Plugin). Wspolautor rozwiazania @Builder oraz ExternalStrategyBuilder w Groovy. Wspolautor biblioteki Micro-Infra-Spring. Wspolzalozyciel Warszawskiej Grupy Uzytkonikow Grooviego (WGUG).</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul> \n  ');
buf.push.apply(buf, __indent);
buf.push('<li><a href="#/meeting/20">20. Groovy</a></li>\n');
buf.push.apply(buf, __indent);
buf.push('</ul>');
}
}, "Marcin Grzejszczak", "marcin_grzejszczak");
__indent.pop();
__indent.push('            ');
prelegent_mixin.call({
block: function(){
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Na co dzień pracuje w 4finance i prawdopodobnie do końca życia budowałby w mavenie gdyby firma nie zmusiła go do przejścia na gradle. Dziś nie żałuje niczego.</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul>\n  ');
buf.push.apply(buf, __indent);
buf.push('<li><a href="#/meeting/18">18. Gradle</a></li>\n');
buf.push.apply(buf, __indent);
buf.push('</ul>');
}
}, "Dawid Kublik", "dawid_kublik");
__indent.pop();
__indent.push('            ');
prelegent_mixin.call({
block: function(){
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Większość życia spędził pisząc w javie, ale zdarzało mu się oskryptowywać różne rzeczy w pythonie lub shellu. Ostatnio szczęśliwy użytkownik grooviego. Uwielbia testowanie oraz wszelką automatyzację w procesie wytwarzania oprogramowania. Stara się dbać o czystość kodu (własnego i cudzego) pooprzez częste code review.</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul> \n  ');
...
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Polak-Meksykanin, Matematyk z wykształcenia. Interesuję się programowaniem funkcyjnym i metodami formalnymi. Używam od 5 lat Guice produkcyjnie.</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul> \n  ');
...
buf.push.apply(buf, __indent);
buf.push('<li><a href="#/meeting/18">18. Maven</a></li>\n');
buf.push.apply(buf, __indent);
buf.push('</ul>');
}
...
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Jestem programistą w firmie Pragmatists, gdzie na co dzień stosuję Test Driven Design, Pair Programming i wiele innych technik zapożyczonych z XP. Interesuję się Domain Driven Design, technikami tworzenia czystego kodu, XP, oraz usprawnianiem pracy zespołów agilowych. Jestem też jednym z organizatorów Jinkubatora.</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul> \n  ');
...
buf.push.apply(buf, __indent);
buf.push('<li><a href="#/meeting/19">19. TDD</a></li>\n');
buf.push.apply(buf, __indent);
buf.push('</ul>');
}
...
buf.push('\n');
buf.push.apply(buf, __indent);
buf.push('<p>Na co dzień rozwija backendowe usługi i aplikacje webowe w Allegro, wcześniej szukał bozonu Higgsa w CERN. Przez większość czasu żyje w świecie Javy i JVM, ale chętnie wraca do Pythona. W ramach odskoczni od IT uwielbia aktywny wypoczynek pod każdą postacią.</p>\n');
buf.push.apply(buf, __indent);
buf.push('<h4>Poprowadzone spotkania</h4>\n');
buf.push.apply(buf, __indent);
buf.push('<ul> \n  ');
...
buf.push.apply(buf, __indent);
buf.push('<li><a href="#/meeting/22">22.  Guava - niezbędnik programisty</a></li>\n');
buf.push.apply(buf, __indent);
buf.push('</ul>');
}
